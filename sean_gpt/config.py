...
class Settings(BaseSettings):
    ...
    api_db_password: str = Field(default="TEST_SEAN_GPT_DB_PASSWORD", alias='sean_gpt_api_db_password')
    openai_api_key: str = Field(default="TEST_OPENAI_API_KEY", alias='sean_gpt_openai_api_key')
    user_admin_phone: str = Field(default="TEST_USER_ADMIN_PHONE", alias='sean_gpt_user_admin_phone')
    user_admin_password: str = Field(default="TEST_USER_ADMIN_PASSWORD", alias='sean_gpt_user_admin_password')
    twilio_test_sid: str = Field(default="TEST_TWILIO_SID", alias='sean_gpt_twilio_test_sid')
    twilio_test_auth_token: str = Field(default="TEST_TWILIO_AUTH_TOKEN", alias='sean_gpt_twilio_test_auth_token')
    twilio_sid: str = Field(default="TEST_TWILIO_SID", alias='sean_gpt_twilio_sid')
    twilio_auth_token: str = Field(default="TEST_TWILIO_AUTH_TOKEN", alias='sean_gpt_twilio_auth_token')
    ...
    jwt_verification_token_expire_minutes: int = Field(alias='sean_gpt_jwt_verification_token_expire_minutes')
